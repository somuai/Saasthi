...
export const AUTH_USER_KEY = "medilift_auth_user_json";
export const AUTH_WORKER_KEY = "medilift_auth_worker_json";
/** Survives app kill between login and OTP verify */
export const AUTH_PENDING_PHONE_KEY = "medilift_auth_pending_phone";
export const AUTH_PENDING_LOCALE_KEY = "medilift_auth_pending_locale";
