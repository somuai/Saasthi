# MEDILIFT Backend Pilot

Django/DRF backend skeleton for the MEDILIFT Pilot MVP. It includes OTP auth, JWT refresh, RBAC/geography-aware APIs, registry and survey models, rule-based risk scoring, flag dedupe, sync pull/push, audit/sync event logging, config endpoints, and a small supervisor dashboard/export surface.
